# K6 Unique Accounts Replica Comparison (Kafka 3 Brokers + DB Split)
...
|---|---:|---:|---:|
| Average latency (s) | 0.1733 | 8.1031 | 9.6407 |
| Fastest (s) | 0.1364 | 0.1405 | 0.1407 |
| Slowest (s) | 0.2606 | 30.2460 | 30.2364 |
| Requests/sec | 377.2346 | 7.0490 | 5.8086 |
...
| 指標 | 1 replicas | 3 replicas | 5 replicas |
|---|---:|---:|---:|
| HTTP p95 (s) | 0.0266 | 0.0098 | 0.0092 |
| HTTP p99 (s) | 0.0382 | 0.0133 | 0.0107 |
| HTTP error rate (/s) | 0.0000 | 0.0000 | 0.0000 |
| trade_saga p95 (s) | N/A | N/A | N/A |
| trade_saga p99 (s) | N/A | N/A | N/A |
| Outbox backlog max | 359.0000 | 10.0000 | 14.0000 |
| Hikari active max | 2.0000 | 1.0000 | 0.0000 |
| Hikari pending max | 0.0000 | 0.0000 | 0.0000 |
| Hikari max | 10.0000 | 10.0000 | 10.0000 |
| Kafka lag max | 17606.0000 | 18458.0000 | 75.0000 |
| Pod CPU sum (cores) | 1.3663 | 0.6542 | 1.8484 |
| Pod Memory sum | 6.59 GiB | 16.89 GiB | 25.37 GiB |
